...
export const AuthorizationModal: FC<AuthorizationFormProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      <div className="auth-form">
        {title === 'Вход' ? (
          <Login switchAuthMode={switchAuthModeToRegister} onClose={onClose} title={title} isOpen={isOpen} />
        ) : (
          <Registration switchAuthMode={switchAuthModeToLogin} onClose={onClose} title={title} isOpen={isOpen} />
        )}
      </div>
    </Modal>
  );
